  ...
  <div id="app" class="min-h-screen bg-gray-50">
      ...
      <div class="max-w-7xl mx-auto px-10 py-4 flex justify-between items-center">
        ...
        <div class="flex items-center space-x-8">
          ...
          <router-link
            v-if="isDoctor"
            to="/doctor/dashboard"
            class="text-gray-700 font-medium hover:text-sky-600 transition font-semibold"
            active-class="text-sky-600 font-bold"
          >
            의사 대시보드
          </router-link>
    ...
    <footer class="bg-gray-100 border-t border-gray-300 mt-20 py-12">
      ...
      <div class="mt-10 text-center text-xs text-gray-500 px-4 leading-relaxed">
        본 서비스는 의료법 가이드라인을 준수하며 AI 기반 참고용 서비스입니다.<br>
        응급상황 시 119 또는 응급실을 방문하세요.
      </div>
...
export default {
  ...
  methods: {
    checkLoginStatus() {
      ...
      this.role = localStorage.getItem("role"); // 🔥 역할 불러오기
    },
